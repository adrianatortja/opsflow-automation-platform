from opsflow.ingestion import read_csv_file, read_json_file, normalize_shopify_orders, read_fake_meta_ads_data
...
meta_ads_data = read_fake_meta_ads_data("data/fake_meta_ads.json")
